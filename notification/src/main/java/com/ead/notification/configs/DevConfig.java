...
@EnableAsync
@EnableScheduling
@EntityScan(basePackages = "com.ead.notification")
@ComponentScan(basePackages = {"com.ead.notification.*"})
@EnableJpaRepositories(basePackages = {"com.ead.notification.repositories"})
